package inci.dashboard.parsers;
...
public class ParserIncidencia {
     ...
     * 
     * @param entrada
     *            - La incidencia en formato JSON
     * @return incidencia - El objeto incidencia
     * @throws JSONException
     * @throws ParseException
     */
    public static Incidence parseStringIncidencia(String entrada) throws JSONException, ParseException {
	...
	Incidence incidencia = new Incidence(nombreUsuario, nombre, descripcion, cords, caducidad, usuario, mapCampos,
		listaEtiquetas);
     ...
     * 
     * @param entrada
     *            - El objeto incidencia
     * @return salida - la incidencia en formateada como JSON
     * @throws JSONException
     * @throws ParseException
     */
    public static String parseIncidenciaString(Incidence entrada) throws JSONException, ParseException {
	...
	String valido = "{\"nombreUsuario\":\"Raul\", " + "\"nombre\":\"Incendio\", "
		+ "\"descripcion\":\"Se ha provocado un incendio en el monte Naranco\","
		+ "\"coordenadas\":{ \"X\":\"-5.866667\",\"Y\":\"43.383333\"}," + "\"comentarios\":[ "
		...
		+ "\"estado\":\"ABIERTA\", " + "\"fecha\":\"11-06-2017\"," + "\"campos\":[ " + "{ \"temp\":\"42\"}, "
		+ "{ \"velocidad viento\":\"10\"} ]," + "\"etiquetas\":[ " + "{ \"texto\":\"Incendio\"}, "
		+ "{ \"texto\":\"Bosque\"} ],"
		+ "\"user\":{ \"name\":\"Raul\",\"email\":\"raul@gmail.com\",\"password\":\"nfdas923nljd\"}}";
	Incidence inci = parseStringIncidencia(valido);
