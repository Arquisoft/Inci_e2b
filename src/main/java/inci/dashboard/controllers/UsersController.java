...
import inci.dashboard.kafka.producers.KafkaProducer;
import inci.dashboard.services.CommentsService;
import inci.dashboard.services.IncidenciasService;
import inci.dashboard.services.UsersService;
...
public class UsersController {
	...
	List<Incidencia> incidencias = incidenciasService
		.getIncidenciasByUser(usersService.getUserByEmail(principal.getName()));
